    ...
    <section className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip overflow-y-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        <HeroOrbit size={520} rotation={-41} shouldOrbit orbitDuration="34s">
          <div className="size-2 bg-emerald-200/20 rounded-full"></div>
        </HeroOrbit>
        <HeroOrbit
          size={530}
          rotation={178}
        ...
        <HeroOrbit size={650} rotation={-5} shouldOrbit orbitDuration="42s">
          <div className="size-3 bg-emerald-200/20 rounded-full"></div>
        </HeroOrbit>
        <HeroOrbit
          size={710}
          rotation={144}
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">
            Building Exceptial User Experience
          </h1>
          <p className="mt-4 text-center text-white/60 md:text-lg">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Qui
            facilis veniam sit error repudiandae inventore facere, natus ratione
            beatae quae?
          </p>
        </div>
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4 z-50">
          <button className="inline-flex items-center gap-2 border border-white/15 px-6 h-12 rounded-xl z-50 ">
            <span className="font-semibold">Explore My Work</span>
            <ArrowDown className="size-4" />
          </button>
          <button className="inline-flex items-center gap-2 border border-white bg-white text-gray-900 h-12 px-6 rounded-xl z-50">
            <span>🖐🏻</span>
